import type { ComputeSlotsOptions, FormattedValue, SignPayload, Slot, WorkdayBody } from '../types';
...
function buildSignPayload(date: string, userId: number, signIn: boolean, time: string): SignPayload {
	return {
		signId: 0,
		userId,
